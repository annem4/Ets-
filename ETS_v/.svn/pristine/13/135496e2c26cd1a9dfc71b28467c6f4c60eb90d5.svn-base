            ...
            try
            {
                ...
                if (Session["dsr"] != null)
                {
                    ...
                    if (blResult == true)
                    {
                        ...
                        Page.ClientScript.RegisterStartupScript(GetType(), "DSR", "alert('DSR Submitted successfully');", true);
                       
                    }
                    else
                    {
                        Page.ClientScript.RegisterStartupScript(GetType(), "New Rerequirement", "alert('DSR Updation is not successful');", true);
                    }
                    Session["dsr"] = null;
                }
                else
