...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="grid_div">
        <table width="100%">
            ...
            <tr runat="server" id="trTaskId" visible="false">
              <td align="left" style="width:20%">Task Id</td>
                <td align="left" style="width: 80%">
                    CR-<asp:Label ID="lblTaskID" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td align="left" style="width:20%">Project Name</td>
                <td align="left" style="width:80%">                    
                    <asp:DropDownList ID="ddlprojname" runat="server" Width="100%" CssClass="select-item" />
                </td>
            </tr>
            <tr>
                <td align="left" style="width:20%">Smoke Test</td>
                <td>
                    <asp:CheckBox ID="Cboxsmoketest" runat="server" />
                </td>
            </tr>
            <tr>
                    ...
                    <asp:GridView ID="GridView1" runat="server" Visible="true" AutoGenerateColumns="false"  Width="351px">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="FileName">
                                <ItemTemplate>
                                    <asp:Label Text='<%#Eval("FileName") %>' ID="lblname" runat="server"  Width="200px" style="word-wrap:break-word"></asp:Label>                                </ItemTemplate>
