...
<script type="text/javascript">
 $(function () {
     $('.manadatory-textbox').autocomplete({
    ...
    <div>
        <table>
            <tr>
                <td>Task ID:</td>
                <td>
                    <asp:TextBox ID="txtContactsSearch" runat="server" CssClass="manadatory-textbox "  AutoPostBack="true" OnTextChanged="txtTaskSearch_TextChanged" Height="16px" Width="73px"></asp:TextBox>
                </td>
                <td>
                    <asp:ImageButton id="imgRefresh" runat="server" ImageUrl="~/Images/Refresh.png" Width="20" Height="20" OnClick="imgRefresh_Click" style="margin-top: 0px"/>
                </td>
            </tr>
             <tr>
                 <td>Title</td>
                 <td>
                     <asp:DropDownList ID="ddlTitlesearch" runat="server" OnSelectedIndexChanged="txtTitleSearch_TextChanged" AutoPostBack="true" />
                 </td>
                <td>                    
                    <asp:TextBox ID="txtTitleSearch" runat="server" AutoPostBack="true" OnTextChanged="txtTitleSearch_TextChanged" Width="164px"></asp:TextBox>
                </td>      
            </tr>
   </table>
    </div>
