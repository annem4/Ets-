   ...
   public class DA_Task : CommonUtility
    {
        ...
        /// //Raghavendra Bathula
        /// //DATE=05-06-2018
        /// Fetch Task Details by Title
        /// </summary>
        /// <param name="strUserCode"></param>
        /// <param name="strTaskID"></param>
        /// <param name="iNoOfEfforts"></param>
        public List<Task> fetchTitle(string searchTitle )  
        {
            try
            {
                IDbDataParameter[] arrParameter = new IDbDataParameter[]{
                                DB_UTILITY.CreateParameter("@filter", DbType.String, ParameterDirection.Input, searchTitle )                              
                };

                _dsResultSet = CommonUtility.DB_UTILITY.RunSP("usp_fetchTaskTitleDetails", arrParameter);
