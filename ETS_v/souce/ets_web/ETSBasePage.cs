...
namespace ets_web
{
    ...
    {       
        ...
        { { 0, "New" }, { 1, "Assigned" }, { 2, "InProgress" }, { 3, "Blocked" }, { 4, "Rejected" }, { 5, "Closed" }, {6, "Resolved"}, {7, "Done"}, {8, "ReOpen"}, { 9, "Done" }  };
        ...
        public static Dictionary<int, string> requirementddltitlesearch = new Dictionary<int, string>()
        { { 1, "Starts With" }, { 2, "Ends With" }, { 3, "Contains" },{4,"Not Contains"} };
